...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidBecomeActive(application: UIApplication) {
        ...
        if launchLogin && loginViewController.presentingViewController == nil {
            var topMostViewController = self.window?.rootViewController
            ...
            topMostViewController?.presentViewController(loginViewController, animated: true, completion: nil)
        }
